...
![](../../../.gitbook/assets/9.2admin105900forumtypes.png) 
...
2. Click on the **Page Sizes** tab.
3. Click in the number field beside **Forum**, and enter the maximum number of posts you want to allow on a page.
4. Click **Save**.
