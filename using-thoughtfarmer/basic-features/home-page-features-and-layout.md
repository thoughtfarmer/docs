...
* **Bookmarks:** Displays a list of pages that you have bookmarked. This Card contains the same information that is found in the Bookmarks menu on the Application Toolbar. You can add, rename and remove bookmarks from the Bookmarks Card. \([Learn more about Bookmarks](https://documentation.thoughtfarmer.com/documentation/105782/bookmarks/).\)
...
![](../../.gitbook/assets/qucik-links.png)
